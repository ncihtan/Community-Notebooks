...
remains valid. As a result, some tables retain names ending in `r4`,
indicating they have not been updated since Release 4.0, but are still
current for Release 6.0.

To choose a different release, edit the BigQuery table names in this
notebook by replacing the string `r4` with a selected numbered release,
